...
> SYSTEM STATUS: READY TO COMPILE.`}
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-2 text-xs">
                            ...
                            <div className="border border-zinc-300 p-2">
                                <div className="font-bold text-black">FABRICATION</div>
                                <div className="text-zinc-400">STATUS: STANDBY</div>
                            </div>
                            <div className="border border-zinc-300 p-2">
                                <div className="font-bold text-black">DATA_VISUALIZATION</div>
                                <div className="text-zinc-400">STATUS: ACTIVE</div>
                            </div>
                            <div className="border border-zinc-300 p-2">
                                <div className="font-bold text-black">SYSTEM_ARCHITECTURE</div>
