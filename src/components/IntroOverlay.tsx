...
export function IntroOverlay() {
    ...
    return (
        <div
            onClick={handleEnter}
            className={`fixed inset-0 z-[9999] flex items-center justify-center bg-[#F4F4F4]/90 backdrop-blur-md text-black font-mono text-xs sm:text-base ${ready ? "cursor-pointer" : "cursor-wait"}`}
        >
